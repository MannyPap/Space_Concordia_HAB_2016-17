...
const float magn_ellipsoid_center[3] = {5.23300, 113.130, -159.480};
const float magn_ellipsoid_transform[3][3] = {{0.952082, -0.0104558, -0.00532249}, {-0.0104558, 0.961312, -0.00709875}, {-0.00532249, -0.00709875, 0.998441}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) 26.59)
#define GYRO_AVERAGE_OFFSET_Y ((float) 25.67)
#define GYRO_AVERAGE_OFFSET_Z ((float) -0.42)
